            ...
            <FlatList
                ...
                renderItem={({item})=>(
                    <View style={styles.content}>
                        <TouchableOpacity style={{width:"100%", alignItems:"center", }} onPress={()=>navigation.push('Scr3',{data:item})} >
                        ...
                        <View style={{flexDirection:"row", justifyContent:"space-between", width:"90%", marginTop:8}}>
                            ...
                            <Image source={require('../assets/Image 181.png')} style={{width:20, height:26,alignItems:"center", justifyContent:"space-evenly"}} ></Image>
